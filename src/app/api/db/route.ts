  ...
  try {
    switch (t) {
      ...
      case 'rsvp-settings': {
        ...
        const allowed = ['accentColor','secondaryColor','bgColor','tertiaryColor','swatchBridesmaids','swatchSuits','swatchVenue','swatchFlowers','heroImage','photo1','photo2','photo3','heading','subheading','dateText','venueText','searchLabel','attendingLabel','declineLabel','confirmedMessage','declinedMessage','contactEmail','weddingDate','coupleNames','ourStory','dressCode','dressCodeNote','ceremonyTime','receptionTime']
