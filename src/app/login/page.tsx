      ...
      <div style={{ width:'100%', maxWidth:420 }}>
        ...
        <div style={{ background:'#1a2419', borderRadius:20, padding:36, border:'1px solid #2a3829', boxShadow:'0 30px 80px rgba(0,0,0,0.5)' }}>
          ...
          <div style={{ position:'relative', marginBottom:12 }}>
            <input type={show ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} onKeyDown={e => e.key === 'Enter' && login()} placeholder="Password" autoFocus
              ...
              onFocus={e => { e.target.style.borderColor='var(--sage)'; e.target.style.boxShadow='0 0 0 3px var(--sage)20' }}
          ...
          <button onClick={login} disabled={loading || !password.trim()}
